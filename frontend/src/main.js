        ...
        loginForm.addEventListener('submit', (e) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    console.log('10. Access token length:', (_a = result.access_token) === null || _a === void 0 ? void 0 : _a.length);
                    ...
                    console.log('15. Stored token preview:', (storedToken === null || storedToken === void 0 ? void 0 : storedToken.substring(0, 50)) + '...');
...
function assignProject(projectId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const availableUsers = users.filter((user) => !user.project);
            ...
            if (!userId)
                return;
            const response = yield fetch('http://localhost:3000/projects/assign', {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json'
